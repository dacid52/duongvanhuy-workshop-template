...
### Week 1 Objectives:
* Review the AWS platform and its main service groups.
* Set up the account environment and define a practical learning roadmap for the internship period.
* Learn cost-awareness principles and complete introductory labs on AWS.
...
* Completed the initial account setup and defined a study roadmap for the internship.
* Developed early awareness of AWS cost management and completed additional introductory labs during the first week.
